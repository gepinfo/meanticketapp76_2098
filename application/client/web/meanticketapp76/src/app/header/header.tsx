...
<img id="i4dr2" src="https://cdn.grapedrop.com/uf9ef8595751c4d1f87c91168f5d51a8c/dad97ef59d704ea0b66e4e5416c67f0a_new_logo_gep.png" className=""/>
</div>
</div>
</div>
<div id="ilhu9k"  className="cell gpd-clm">
<div id="iw7pyc" className="gpd-text">
<div id="template-i02d" className="">
{UserName}</div>
</div>
<label htmlFor="fileInput" id="template-iupy" className="hoverable">
<img id="jn87dj" src={ images} className=""/>
</label>
<input id="fileInput" type="file" onChange={(e)=>onSelectFile(e)} accept="image/png, image/gif, image/jpeg" className=""/>
...
{check?(<div id="icrvgp" className="cell gpd-clm"  >
                                                        <div id="i6vd27" className="gdp-row gpd-grid"  >
                                                            ...
                                                            <div id="iytw4t" className="cell gpd-clm" >
                                                                <a id="i9imej" className="gpd-text" href="#severity" data-toggle="collapse" data-parent="#MainMenu">severity <i className="fa fa-caret-down"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>):<></>}
                                                    {check?( <div className="collapse" id="severity">
                                                        <div id="icrvgp" className="cell gpd-clm">
                                                            <div id="i6vd27" className="gdp-row gpd-grid">
                                                                <div id="iytw4t" className="cell gpd-clm">
<a id="i9imej" className="gpd-text" href='/createseverity'>createseverity</a>
                                        
<a id="i9imej" className="gpd-text" href='/getallseverity'>getallseverity</a>
...
{check?(<div id="icrvgp" className="cell gpd-clm"  >
                                                        <div id="i6vd27" className="gdp-row gpd-grid"  >
                                                            ...
                                                            <div id="iytw4t" className="cell gpd-clm" >
                                                                <a id="i9imej" className="gpd-text" href="#servicetypes" data-toggle="collapse" data-parent="#MainMenu">servicetypes <i className="fa fa-caret-down"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>):<></>}
                                                    {check?( <div className="collapse" id="servicetypes">
                                                        <div id="icrvgp" className="cell gpd-clm">
                                                            <div id="i6vd27" className="gdp-row gpd-grid">
                                                                <div id="iytw4t" className="cell gpd-clm">
<a id="i9imej" className="gpd-text" href='/createtype'>createtype</a>
                                        
<a id="i9imej" className="gpd-text" href='/getalltypes'>getalltypes</a>
...
{check?(<div id="icrvgp" className="cell gpd-clm"  >
                                                        <div id="i6vd27" className="gdp-row gpd-grid"  >
                                                            ...
                                                            <div id="iytw4t" className="cell gpd-clm" >
                                                                <a id="i9imej" className="gpd-text" href="#ticketapp" data-toggle="collapse" data-parent="#MainMenu">ticketapp <i className="fa fa-caret-down"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>):<></>}
                                                    {check?( <div className="collapse" id="ticketapp">
                                                        <div id="icrvgp" className="cell gpd-clm">
                                                            <div id="i6vd27" className="gdp-row gpd-grid">
                                                                <div id="iytw4t" className="cell gpd-clm">
<a id="i9imej" className="gpd-text" href='/createticket'>createticket</a>
                                        
<a id="i9imej" className="gpd-text" href='/updatetickets'>updatetickets</a>
                                        
<a id="i9imej" className="gpd-text" href='/getallticket'>getallticket</a>
                                        
<a id="i9imej" className="gpd-text" href='/searchtickets'>searchtickets</a>
